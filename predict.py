    ...
    if mode == "predict":
        ...
        while True:
            ...
            try:
                ...
                #image = Image.open("img/15.jpg")
                image = Image.open("VOCdevkit/C/JPEGImages/1.jpg")
                #image = Image.open("VOCdevkit/S2TLD/JPEGImages/000111.jpg")
                #image = Image.open("VOCdevkit/S2TLD/JPEGImages/000207.jpg")
            except:
                print('Open Error! Try again!')
                continue
            else:
                r_image,dics = yolo.detect_image(image)
